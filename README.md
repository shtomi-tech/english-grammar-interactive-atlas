...
- `src/components/demos/`: 共通Demo枠、7つのDemo、Demo Registry
- `src/lib/grammar/`: 正誤判定、分類判定、文型図生成、修飾関係検索、文法状態からの英文生成
...
Lesson 01「文の骨格を見抜く」とLesson 02「英文の構造を読む」はCatalogのGuided lessonsから開けます。LessonはProblem IDで問題を参照し、同じComponentへ別のProblem Dataを渡せます。ProblemとLessonの検証は `npm run check` に含まれます。
