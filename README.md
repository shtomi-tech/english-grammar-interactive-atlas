...
- `src/components/demos/`: 共通Demo枠、9つのDemo、Demo Registry
- `src/lib/grammar/`: 正誤判定、分類判定、文型図生成、修飾関係検索、比較・訂正判定、場面文法判定、文法状態からの英文生成
