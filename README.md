...
- `src/lib/grammar/`: 正誤判定、分類判定、文型図生成、修飾関係検索、比較・訂正判定、場面文法判定、生成目標判定、時制・助動詞・能動態/受動態を含む文法状態からの英文生成、文法状態・control label契約
