...
Sentence TransformerとSentence Generatorの文法状態契約は [GRAMMAR_STATE_CONTRACT.md](./GRAMMAR_STATE_CONTRACT.md) に分離して管理します。既存10 Demoの学習行為は共通化せず、共通化するのは対応する文法値・状態モード・表示ラベルの契約だけです。
